...
impl UpdateAmmConfig {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = UpdateAmmConfigInstructionData::new().try_to_vec().unwrap();
...
impl UpdateAmmConfigInstructionArgs {
    pub(crate) fn try_to_vec(&self) -> Result<Vec<u8>, std::io::Error> {
        borsh::to_vec(self)
    }
}
...
impl UpdateAmmConfigBuilder {
    pub fn new(amm_config: solana_pubkey::Pubkey, param: u8, value: u64) -> Self {
        Self {
            owner: None,
            amm_config,
            param,
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        let owner = self.owner.unwrap_or(solana_pubkey::pubkey!(
