...
pub struct SwapBaseInput {
    ...
    pub input_token_account: solana_address::Address,
    /// The user token account for output token
    pub output_token_account: solana_address::Address,
    /// The vault token account for input token
    pub input_vault: solana_address::Address,
    /// The vault token account for output token
    pub output_vault: solana_address::Address,
    /// SPL program for input token transfers
    pub input_token_program: solana_address::Address,
    /// SPL program for output token transfers
    pub output_token_program: solana_address::Address,
    /// The mint of input token
    pub input_token_mint: solana_address::Address,
    /// The mint of output token
    pub output_token_mint: solana_address::Address,
    /// The program account for the most recent oracle observation
    pub observation_state: solana_address::Address,
}
