...
impl UpdatePoolStatus {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = UpdatePoolStatusInstructionData::new().try_to_vec().unwrap();
...
impl UpdatePoolStatusInstructionArgs {
    pub(crate) fn try_to_vec(&self) -> Result<Vec<u8>, std::io::Error> {
        borsh::to_vec(self)
    }
}
...
impl UpdatePoolStatusBuilder {
    pub fn new(pool_state: solana_pubkey::Pubkey, status: u8) -> Self {
        Self {
            authority: None,
            pool_state,
            status,
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        let authority = self.authority.unwrap_or(solana_pubkey::pubkey!(
