...
impl BuyExactIn {
    pub fn instruction(&self, args: BuyExactInInstructionArgs) -> solana_instruction::Instruction {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = BuyExactInInstructionData::new().try_to_vec().unwrap();
...
impl BuyExactInInstructionArgs {
    pub(crate) fn try_to_vec(&self) -> Result<Vec<u8>, std::io::Error> {
        borsh::to_vec(self)
    }
}
