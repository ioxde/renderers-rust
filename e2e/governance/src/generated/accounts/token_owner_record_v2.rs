...
impl<'a> TryFrom<&solana_account_info::AccountInfo<'a>> for TokenOwnerRecordV2 {
...
#[cfg(feature = "fetch")]
pub fn fetch_token_owner_record_v2(
    rpc: &solana_client::rpc_client::RpcClient,
    address: &solana_pubkey::Pubkey,
) -> Result<crate::shared::DecodedAccount<TokenOwnerRecordV2>, std::io::Error> {
    let accounts = fetch_all_token_owner_record_v2(rpc, &[*address])?;
    Ok(accounts[0].clone())
}

#[cfg(feature = "fetch")]
pub fn fetch_all_token_owner_record_v2(
    rpc: &solana_client::rpc_client::RpcClient,
...
#[cfg(feature = "fetch")]
pub fn fetch_maybe_token_owner_record_v2(
    rpc: &solana_client::rpc_client::RpcClient,
    address: &solana_pubkey::Pubkey,
) -> Result<crate::shared::MaybeAccount<TokenOwnerRecordV2>, std::io::Error> {
    let accounts = fetch_all_maybe_token_owner_record_v2(rpc, &[*address])?;
    Ok(accounts[0].clone())
}

#[cfg(feature = "fetch")]
pub fn fetch_all_maybe_token_owner_record_v2(
    rpc: &solana_client::rpc_client::RpcClient,
    addresses: &[solana_pubkey::Pubkey],
...
#[cfg(feature = "anchor")]
impl anchor_lang::AccountDeserialize for TokenOwnerRecordV2 {
...
#[cfg(feature = "anchor")]
impl anchor_lang::AccountSerialize for TokenOwnerRecordV2 {}
...
impl anchor_lang::IdlBuild for TokenOwnerRecordV2 {}

#[cfg(feature = "anchor-idl-build")]
impl anchor_lang::Discriminator for TokenOwnerRecordV2 {
