...
impl<'a> TryFrom<&solana_account_info::AccountInfo<'a>> for VoteRecordV2 {
...
pub fn fetch_all_vote_record_v2(
    ...
    let mut decoded_accounts: Vec<crate::shared::DecodedAccount<VoteRecordV2>> = Vec::new();
    for i in 0..addresses.len() {
        ...
        let data = VoteRecordV2::from_bytes(&account.data)?;
...
pub fn fetch_all_maybe_vote_record_v2(
    ...
    let accounts = rpc
        .get_multiple_accounts(addresses)
        .map_err(|e| std::io::Error::other(e.to_string()))?;
    let mut decoded_accounts: Vec<crate::shared::MaybeAccount<VoteRecordV2>> = Vec::new();
    for i in 0..addresses.len() {
        let address = addresses[i];
...
#[cfg(feature = "anchor")]
impl anchor_lang::AccountDeserialize for VoteRecordV2 {
...
#[cfg(feature = "anchor")]
impl anchor_lang::AccountSerialize for VoteRecordV2 {}

#[cfg(feature = "anchor")]
impl anchor_lang::Owner for VoteRecordV2 {
...
impl anchor_lang::IdlBuild for VoteRecordV2 {}

#[cfg(feature = "anchor-idl-build")]
impl anchor_lang::Discriminator for VoteRecordV2 {
