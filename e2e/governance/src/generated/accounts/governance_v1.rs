...
impl<'a> TryFrom<&solana_account_info::AccountInfo<'a>> for GovernanceV1 {
...
pub fn fetch_all_governance_v1(
    ...
    let mut decoded_accounts: Vec<crate::shared::DecodedAccount<GovernanceV1>> = Vec::new();
    for i in 0..addresses.len() {
        ...
        let data = GovernanceV1::from_bytes(&account.data)?;
...
pub fn fetch_all_maybe_governance_v1(
    ...
    let accounts = rpc
        .get_multiple_accounts(addresses)
        .map_err(|e| std::io::Error::other(e.to_string()))?;
    let mut decoded_accounts: Vec<crate::shared::MaybeAccount<GovernanceV1>> = Vec::new();
    for i in 0..addresses.len() {
        let address = addresses[i];
...
#[cfg(feature = "anchor")]
impl anchor_lang::AccountDeserialize for GovernanceV1 {
...
#[cfg(feature = "anchor")]
impl anchor_lang::AccountSerialize for GovernanceV1 {}

#[cfg(feature = "anchor")]
impl anchor_lang::Owner for GovernanceV1 {
...
impl anchor_lang::IdlBuild for GovernanceV1 {}

#[cfg(feature = "anchor-idl-build")]
impl anchor_lang::Discriminator for GovernanceV1 {
