...
pub const FLAG_TRANSACTION_ERROR_DISCRIMINATOR: u8 = 20;
...
impl FlagTransactionError {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let data = FlagTransactionErrorInstructionData::new()
            .try_to_vec()
            .unwrap();
...
impl FlagTransactionErrorInstructionData {
    pub fn new() -> Self {
...
impl Default for FlagTransactionErrorInstructionData {
    fn default() -> Self {
        Self::new()
    }
}

/// Instruction builder for `FlagTransactionError`.
///
/// ### Accounts:
///
...
/// `flag_transaction_error` CPI accounts.
pub struct FlagTransactionErrorCpiAccounts<'a, 'b> {
...
/// `flag_transaction_error` CPI instruction.
...
impl<'a, 'b> FlagTransactionErrorCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_account_info::AccountInfo<'a>,
        accounts: FlagTransactionErrorCpiAccounts<'a, 'b>,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `FlagTransactionError` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` proposal_account
...
///   3. `[writable]` proposal_transaction_account
#[derive(Clone, Debug)]
pub struct FlagTransactionErrorCpiBuilder<'a, 'b> {
    instruction: Box<FlagTransactionErrorCpiBuilderInstruction<'a, 'b>>,
}
